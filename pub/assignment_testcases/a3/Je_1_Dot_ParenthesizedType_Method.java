 ...
 * System does not resolve to a field or local variable.
 */
public class Je_1_Dot_ParenthesizedType_Method {

    public Je_1_Dot_ParenthesizedType_Method(){}

    public static int test() {
	(System).getProperties(); // (name).method()
	return 123;
    }
