 ...
 */
public class Je_6_ConstructorPresent_TooManyArguments {

    public Je_6_ConstructorPresent_TooManyArguments() {}

    public static int test() {
        new Je_6_ConstructorPresent_TooManyArguments("If only Yoda could see you now.");
	return 123;
    }
